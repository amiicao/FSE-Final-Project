...
bp = Blueprint('classarrange', __name__,url_prefix='/')
...
def application():
    ...
    return render_template('application.html', apply=application)
...
def teacher_schedule():
    ...
    return render_template('teacher_schedule.html', application=application)
